...
const NAV = [
  ...
  { href: '/hospitalizacion', label: 'Hospitalización y Urgencias', ic: 'cama', roles: ['PHYSICIAN', 'NURSE', 'EPS_ADMIN', 'SUPERADMIN'] },
  { href: '/asistencial', label: 'Diagnósticos y domiciliaria', ic: 'dx', roles: ['PHYSICIAN', 'NURSE', 'NUTRITIONIST', 'EPS_ADMIN', 'SUPERADMIN'] },
  { href: '/facturacion', label: 'Facturación y RIPS', ic: 'factura', roles: ['EPS_ADMIN', 'SUPERADMIN'] },
  { href: '/inventario', label: 'Inventario', ic: 'inventario', roles: ['EPS_ADMIN', 'SUPERADMIN', 'NURSE', 'PHYSICIAN'] },
  { href: '/reportes', label: 'Reportes', ic: 'reportes', roles: ['EPS_ADMIN', 'SUPERADMIN', 'AUDITOR'] },
